...
| [`rnd-creator-product`](./skills/rnd-creator-product) | Quy trình R&D một sản phẩm cho creator/founder đã có audience, dùng chung cho 6 format (physical/digital/SaaS/service/course/community). Ép agent validate willingness-to-pay… | `R&D sản phẩm creator`, `build sản phẩm mới`, `chọn sản phẩm gì bán`, `prototype ý tưởng`, `creator nên bán gì` |
